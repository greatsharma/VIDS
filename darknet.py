...
if os.name == "nt":
    ...
    cwd = "C:/darknet/build/darknet/x64/"
    ...
    lib = CDLL("/home/gaurav/darknet/libdarknet.so", RTLD_GLOBAL)
...
def performBatchDetect(
    ...
    net = load_net_custom(
        configPath.encode("utf-8"), weightPath.encode("utf-8"), 0, batch_size
    )
    ...
    batch_dets = network_predict_batch(
        net, im, batch_size, pred_width, pred_height, thresh, hier_thresh, None, 0, 0
    )
    batch_boxes = []
    batch_scores = []
    batch_classes = []
